...
<div class="container">
  <div class="page-inner">
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
      <div>
        <h3 class="fw-bold mb-3">Edit Data Absensi</h3>
        <h6 class="op-7 mb-2">Perbarui data absensi peserta PKL / Magang</h6>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card card-round shadow-sm">
          ...
          <div class="card-body">
            <form action="../../actions/attendance/update.php" method="POST">
              ...
              <div class="mb-3">
                ...
                <select name="participant_id" id="participant_id" class="form-control" required>
                  ...
                  <?php while ($p = mysqli_fetch_assoc($qParticipants)) : ?>
                    <option value="<?= $p['id'] ?>" <?= ($p['id'] == $data['participant_id']) ? 'selected' : '' ?>>
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  ...
                  <input type="datetime-local" name="check_in" id="check_in" class="form-control"
                    value="<?= $data['check_in'] ? date('Y-m-d\TH:i', strtotime($data['check_in'])) : '' ?>">
                </div>
                <div class="col-md-6">
                  <label for="check_in_location" class="form-label">Lokasi Check In</label>
                  <input type="text" name="check_in_location" id="check_in_location" class="form-control"
                    value="<?= htmlspecialchars($data['check_in_location'] ?? '') ?>">
                </div>
              </div>
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  ...
                  <input type="datetime-local" name="check_out" id="check_out" class="form-control"
                    value="<?= $data['check_out'] ? date('Y-m-d\TH:i', strtotime($data['check_out'])) : '' ?>">
                </div>
                <div class="col-md-6">
                  <label for="check_out_location" class="form-label">Lokasi Check Out</label>
                  <input type="text" name="check_out_location" id="check_out_location" class="form-control"
                    value="<?= htmlspecialchars($data['check_out_location'] ?? '') ?>">
                </div>
              </div>
