      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 col-md-12 col-12">
          <div class="header-image">
            <img src="../frontend/template-user/assets/images/header/hero-image.jpg" alt="#" />
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row align-items-center">
        <div class="col-lg-6 col-12">
          <div class="about-image-five">
            ...
            <img src="../frontend/template-user/assets/images/about/about-img1.jpg" alt="about" />
          </div>
        </div>
        <div class="col-lg-6 col-12">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6 col-12">
          ...
          <div class="single-news">
            <div class="image">
              <a href="javascript:void(0)"><img class="thumb" src="../frontend/template-user/assets/images/blog/1.jpg" alt="Blog" /></a>
              <div class="meta-details">
                <img class="thumb" src="../frontend/template-user/assets/images/blog/b6.jpg" alt="Author" />
        ...
        <div class="col-lg-4 col-md-6 col-12">
          ...
          <div class="single-news">
            <div class="image">
              <a href="javascript:void(0)"><img class="thumb" src="../frontend/template-user/assets/images/blog/2.jpg" alt="Blog" /></a>
              <div class="meta-details">
                <img class="thumb" src="../frontend/template-user/assets/images/blog/b6.jpg" alt="Author" />
                <span>BY TIM NORTON</span>
              </div>
        ...
        <div class="col-lg-4 col-md-6 col-12">
          ...
          <div class="single-news">
            <div class="image">
              <a href="javascript:void(0)"><img class="thumb" src="../frontend/template-user/assets/images/blog/3.jpg" alt="Blog" /></a>
              <div class="meta-details">
                <img class="thumb" src="../frontend/template-user/assets/images/blog/b6.jpg" alt="Author" />
                <span>BY TIM NORTON</span>
              </div>
        ...
        <div class="col-lg-8 offset-lg-2 col-12">
          <div class="clients-logos">
            <div class="single-image">
              <img src="../frontend/template-user/assets/images/client-logo/graygrids.svg" alt="Brand Logo Images" />
            </div>
            <div class="single-image">
              <img src="../frontend/template-user/assets/images/client-logo/uideck.svg" alt="Brand Logo Images" />
            </div>
            <div class="single-image">
              <img src="../frontend/template-user/assets/images/client-logo/ayroui.svg" alt="Brand Logo Images" />
            </div>
            <div class="single-image">
              <img src="../frontend/template-user/assets/images/client-logo/lineicons.svg" alt="Brand Logo Images" />
            </div>
            <div class="single-image">
              <img src="../frontend/template-user/assets/images/client-logo/tailwindtemplates.svg" alt="Brand Logo Images" />
            </div>
            <div class="single-image">
              <img src="../frontend/template-user/assets/images/client-logo/ecomhtml.svg" alt="Brand Logo Images" />
            </div>
          </div>
        </div>
      </div>
